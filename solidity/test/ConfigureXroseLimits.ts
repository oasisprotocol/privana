// Unit tests for configureXroseLimitsIfNeeded and assertXroseBridgeConfig against a locally-deployed XRose + ROFLBridge pair.
...
describe("ConfigureXroseLimits", () => {
  ...
  // shape, so this mirrors production.
