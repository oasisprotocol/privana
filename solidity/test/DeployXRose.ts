// Integration tests for `deployCreate3IfMissing` (xROSE path) against an in-process CreateX
// installed via `hardhat_setCode`. Exercises the spec's "red expectation":
...
describe("DeployXRose", () => {
  ...
  // Same defaults the Phase 0 master plan pins for xROSE.
