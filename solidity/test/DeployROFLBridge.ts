// Integration tests for the ROFLBridge CREATE3 deploy path against an
// in-process CreateX installed via `hardhat_setCode`. Exercises the spec's
// red expectations (`docs/plans/rose-bridge-phase0/05-createx-deploy/04-deploy-rofl-bridge.md`):
