...
sidebar_position: 7
description: "The services Privana connects to, and what each one does."
---
...
| Service | What Privana uses it for |
| --- | --- |
...
Privana is deliberately assembled from public, auditable infrastructure rather
than bespoke arrangements. Every service above can be swapped for another that
offers the same interface, and several are chosen precisely because they are
widely used and independently operated.

If you represent one of these services and would like your name or logo removed
